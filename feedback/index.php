...
$form['form-order'] = array(
    ...
    'form-order__email' => array(
      'title' => 'E-mail',
      'validate' => array(
        'preg' => '/^[-\w]+@[a-zA-Z_]+?\.[a-zA-Z_]{2,6}$/',
        'minlength' => '3',
        'maxlength' => '35',
      ),
      'messages' => array(
...
$form['form-feedback'] = array(
	'fields' => array(
		'form-feedback__name' => array(
			'title' => 'Имя',
			'validate' => array(
				'preg' => '%[A-Z-a-zА-Яа-я\s]%',
				'minlength' => '3',
